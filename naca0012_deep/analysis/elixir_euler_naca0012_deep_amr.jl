...
analysis_callback = AnalysisCallback(semi, interval=analysis_interval,
                                     analysis_errors = [:residual,],
                                     output_directory = "analysis_results", save_analysis = true,
		                     analysis_integrals = (TrixiLW.RhoRes(),TrixiLW.RhoV1Res(),TrixiLW.RhoV2Res(),TrixiLW.ERes()))
...
dt_initial = 1e-8;
# cfl_number = 0.1 # crashes for cfl_number = 0.12 for polydeg = 7, mesh deg = 6
cfl_number = 0.15 # Does NOT crash for cfl_number = 0.14 for polydeg = 6, mesh deg = 6. Crashed for cfl_number = 0.16
