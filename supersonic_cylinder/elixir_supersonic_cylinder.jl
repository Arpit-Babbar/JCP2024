...
cfl_number = 0.15 # crashes with cfl_number = 0.16
...
lift_computation = TrixiLW.AnalysisSurfaceIntegral(cache -> cache.boundary_conditions.boundary_indices[4],
                                           TrixiLW.lift_force)
drag_computation = TrixiLW.AnalysisSurfaceIntegral(cache -> cache.boundary_conditions.boundary_indices[4],
                                           TrixiLW.drag_force)
