...
#				        x, t, dt, surface_flux_function, equations, dg, 
#					time_discretization, scaling_factor)
    flux = TrixiLW.boundary_condition_slip_wall_approximate(U_inner, F_inner, u_inner, outer_cache, normal_direction,
				        x, t, dt, surface_flux_function, equations, dg, 
					time_discretization, scaling_factor)
  end
...
mesh = P4estMesh{2}(mesh_file, initial_refinement_level = 4)

cfl_number = 0.3 # crashes for cfl_number = 0.33
