...
#                              mesh_file)
# mesh = P4estMesh{2}(mesh_file, initial_refinement_level = 8)
...
mesh = P4estMesh(trees_per_dimension, polydeg=4,
                 ...
                 initial_refinement_level=8, periodicity = (false, false))
...
amr_controller = ControllerThreeLevel(semi, amr_indicator,
					    base_level=4,
					    med_level=7, med_threshold=0.0003,
					    max_level=9, max_threshold=0.003)
